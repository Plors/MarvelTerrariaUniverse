...
namespace MarvelTerrariaUniverse.Common.UI.IronMan
{
    public class VanillaLifeOverlay : ModResourceOverlay
    {
        ...
        public override void PostDrawResource(ResourceOverlayDrawContext context)
        {
            ...
            //    DrawClassicFancyOverlay(context);
            //}
            if (CompareAssets(asset, barsFolder + "HP_Fill") || CompareAssets(asset, barsFolder + "HP_Fill_Honey"))
            {
        ...
        private void DrawBarsOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = barsFillingTexture ??= ModContent.Request<Texture2D>("MarvelTerrariaUniverse/Common/UI/IronMan/BarsLifeOverlay_Fill");
            context.Draw();
        }
        ...
        private void DrawBarsPanelOverlay(ResourceOverlayDrawContext context)
        {
            ...
            context.texture = barsPanelTexture ??= ModContent.Request<Texture2D>("MarvelTerrariaUniverse/Common/UI/IronMan/BarsLifeOverlay_Panel");
