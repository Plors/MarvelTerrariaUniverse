...
public class ArsenalUnibeam : ArsenalItem
{
    int cd = 0;
    bool offCD = true;
    public override void UpdateArsenal(Player player)
    {
        ...
        if (offCD)
        {
            ...
            Projectile.NewProjectile(Terraria.Entity.GetSource_None(), player.Center, shootDirection * 6f, ModContent.ProjectileType<Repulsor>(), 50, 10, -1, 1);
            offCD = false;
        }
    }
